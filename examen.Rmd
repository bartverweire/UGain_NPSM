...
```{r echo=FALSE}
an.result %>% 
  kable(caption = "Anova output voor de verschillende gam modellen en de verschillende termen")
```
...
Of we kunnen de invloed bekijken van het type test, voor de verschillende combinaties van de andere parameters. 
